...
-->
  <footer class="bg-bsand-600">
    <div class="max-w-screen-xl px-4 py-12 mx-auto sm:px-6 lg:py-16 lg:px-8">
      <div class="xl:grid xl:grid-cols-3 xl:gap-8">
        <div class="grid-cols-3 space-y-4 sm:grid xl:col-span-2 sm:space-y-0">
          <div v-for="(menu, index) in menus" :key="index">
            ...
            <ul class="flex flex-wrap sm:mt-4 sm:space-y-4 sm:block">
              <li
              ...
              >
                <a
                  href="#"
                  class="px-2 mx-1 text-base leading-6 text-bsand-200 hover:text-white sm:px-0 sm:mx-0 sm:bg-transparent bg-bsand-500"
                >
                  {{ menuItem.title }}
                </a>
              </li>
        ...
        <div class="mt-8 xl:mt-0">
          ...
          <form class="mt-4 sm:flex sm:max-w-md">
            ...
            <div class="mt-3 rounded-md sm:mt-0 sm:ml-3 sm:flex-shrink-0">
              <button
                type="submit"
                class="flex items-center justify-center w-full px-4 py-2 text-base font-medium leading-6 text-white transition duration-150 ease-in-out border border-transparent rounded-md bg-bsand-500 hover:bg-bsand-400 focus:outline-none focus:border-bsand-600 focus:shadow-outline-bsand active:bg-bsand-600"
              >
                Subscribe
              </button>
            </div>
      ...
      <div
        class="pt-8 mt-8 border-t border-bsand-400 md:flex md:items-center md:justify-between"
      >
        <div class="flex space-x-6 md:order-2">
          <a href="#" class="text-bsand-400 hover:text-bsand-200">
      ...
      menus: [
        {
          menuName: 'Info',
          menuitems: [
            { title: 'Fri levering alle dage' },
            { title: 'Gratis returret' },
            { title: 'Sikker krypteret betaling' },
            { title: 'e-mærke godkendt' },
            { title: 'Ingen gebyrer på kreditkort' },
            { title: 'Topscorer på Trustpilot' },
          ],
        },
        {
          menuName: 'Om Silkeland',
          menuitems: [
            { title: 'Om os' },
            { title: 'Kontakt' },
            { title: 'Handelsbetingelser' },
            { title: 'Vores prispolitik' },
