<template>
  <div class="relative">
    ...
    <button
      type="button"
      class="inline-flex items-center space-x-2 text-base font-medium leading-6 text-gray-200 transition duration-150 ease-in-out group hover:text-white focus:outline-none focus:text-white"
    ...
    >
      ...
      <!--
          ...
          -->
      <svg
        class="w-5 h-5 text-gray-300 transition duration-150 ease-in-out group-hover:text-white group-focus:text-white"
