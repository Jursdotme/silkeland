      ...
      <div class="px-4 mx-auto max-w-7xl sm:px-6">
        <div class="flex items-center justify-between py-6 md:space-x-10">
          ...
          <nav class="hidden space-x-6 xl:space-x-10 lg:flex">
            <nuxt-link
              to="/productcat"
              class="inline-flex items-center text-base font-medium leading-6 text-gray-200 transition duration-150 ease-in-out hover:text-white"
            >
              Silkedyner
            </nuxt-link>
            <nuxt-link
              to="/productcat"
              class="text-base font-medium leading-6 text-gray-200 transition duration-150 ease-in-out hover:text-white"
            >
              Silkepuder
            </nuxt-link>
            <nuxt-link
            ...
            <HeaderDropDownTransparent :content="silkensabc" />
          </nav>
          <div
            ...
            <div>
              ...
              <div class="relative mt-1 rounded-md shadow-sm">
                <input
                  id="account_number"
                  type="text"
                  class="block w-full border-gray-300 rounded-md shadow-sm focus:ring-bgreen-500 focus:border-bgreen-500 sm:text-sm"
                  placeholder="Søg..."
                />
                <nuxt-link
                  to="/search"
