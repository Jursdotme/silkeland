<template>
  <div class="relative flex flex-col bg-white shadow-lg rounded-3xl">
    <img
      src="bow.png"
      alt=""
      class="absolute z-10 w-28"
      style="top: -31px; left: 30%"
    />
    <nuxt-link to="/product" class="relative flex-shrink-0 overflow-visible">
      <span
        ...
        >Tilbud</span
      >
      <div class="border-b-4 border-green-800 aspect-w-16 aspect-h-9">
        <img class="object-cover rounded-t-3xl" :src="product.image" alt="" />
      </div>
    </nuxt-link>
    <div class="flex flex-col justify-between flex-1 p-6">
      <div class="flex-1">
        <p class="text-sm font-medium leading-5 text-green-800 uppercase">
        ...
        <div v-if="product.inStock" class="flex items-center space-x-2">
          <span
            ...
            >
              ...
              ></path></svg
          ></span>
          <span class="text-red-600">På lager</span>
        </div>
        ...
        <div v-if="product.inStock" class="flex items-center space-x-2">
          <span
            ...
            >
              ...
              ></path></svg
          ></span>
          <span class="text-red-600">1-2 dage</span>
        </div>
      </div>
      <nuxt-link
        to="/product"
        class="block py-2 text-center text-white transition-all duration-100 bg-green-800 rounded-lg shadow-lg hover:bg-red-600 hover:shadow-xl"
        >Køb nu</nuxt-link
      >
    </div>
  </div>
